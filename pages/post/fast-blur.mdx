...
import tidyDrawingsJS from 'sandboxes/tree-drawing/tidy-drawings-of-trees-algorithm1'
import rootJS from 'sandboxes/tree-drawing/root.js'
import utilsJS from 'sandboxes/tree-drawing/utils.js'
import appJS from 'sandboxes/tree-drawing/app.js'
...
<Sandbox
  ...
  files={{
    '/App.js': appJS,
    '/layout.js': { code: tidyDrawingsJS, active: true },
    '/root.js': rootJS,
    '/utils.js': utilsJS
  }}
/>
